    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="nav-link" href="{{ route('webcompany.index') }}">Company setup</a></li>
          <li><a class="nav-link" href="{{ route('webcategory.index') }}">Category</a></li>
        </ul>
      </li>
      <li class="dropdown">
        <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="command"></i><span>Post</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link" href="{{ route('webarticle.index') }}">Article</a></li>
          <li><a class="nav-link" href="{{ route('webad.index') }}">Advertisement</a></li>
